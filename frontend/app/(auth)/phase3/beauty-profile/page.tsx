...
export default function StyleProfilePage() {
  ...
  const scanOutfit = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/phase3/save-user-photo", {
        method: "POST",
        body: formData,
      });
  ...
  const fetchCategories = async () => {
    try {
      ...
      const res = await fetch("/api/phase3/categories", {
        method: "GET",
        headers: {
  ...
  const fetchSaveCategory = async () => {
    try {
      ...
      const res = await fetch("/api/phase3/save-categories", {
        method: "POST",
    ...
    <DashboardLayout>
      ...
      `}
          ...
          <div className="mt-12">
                ...
                <div className="p-4 h-full md:h-full lg:h-full scrollbar-hide">
